...
class Manager extends \Bs\Controller\AdminIface
{
    ...
    public function doDefault(Request $request)
    {
        ...
        $this->table = $this->getConfig()->createTable('event-list');
        ...
        $list = \Tk\Ev\Db\EventMap::create()->findFiltered($this->table->getFilterValues(), $this->table->getTool('a.dateStart DESC'));
